export default function Footer (){
    return(
        <footer className="bg-white py-5 font-sans tracking-wide">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
        <div>
          <h4 className="text-lg font-semibold mb-6 text-black">Funiro</h4>
          <p className="text-gray-400 text-base">400 University Drive Suite 200 Coral Gables,
          FL 33134 USA.</p>
        </div>

        <div>
          <h4 className="text-lg font-semibold mb-6 text-customGrey">Link</h4>
          <ul className="space-y-4">
            <li><a href="javascript:void(0)" className="text-black hover:text-customGrey text-base">Web Development</a></li>
            <li><a href="javascript:void(0)" className="text-black hover:text-customGrey text-base">Mobile App Development</a>
            </li>
            <li><a href="javascript:void(0)" className="text-black hover:text-customGrey text-base">UI/UX Design</a></li>
            <li><a href="javascript:void(0)" className="text-black hover:text-customGrey text-base">Digital Marketing</a></li>
          </ul>
        </div>

        <div className="space-y-4">
          <h4 className="text-lg font-semibold mb-6 text-customGrey">Contact Us</h4>
          <p className="text-black text-base">123 Main Street</p>
          <p className="text-black text-base">City, State, Country</p>
          <p className="text-black text-base">contact@example.com</p>
          <p className="text-black text-base">+1 234 567 890</p>
        </div>

        <div>
          <h4 className="text-lg font-semibold mb-6 text-customGrey">Follow Us</h4>
      ...
      <div className="bg-gray-900 p-5 mt-12">
        <p className='text-gray-400 text-base text-center'>furino. All rights reverved</p>
      </div>
    </footer>
    )
}